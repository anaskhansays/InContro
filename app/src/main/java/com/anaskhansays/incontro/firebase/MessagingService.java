package com.anaskhansays.incontro.firebase;
...
import com.anaskhansays.incontro.activites.IncomingCallActivity;
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if(type!=null){
            if(type.equals(Constants.REMOTE_MESSAGE_INVITE)){
                ...
                intent.putExtra(
                        Constants.REMOTE_MESSAGE_CALL_TYPE,
                        remoteMessage.getData().get(Constants.REMOTE_MESSAGE_CALL_TYPE)
                );
                intent.putExtra(
                ...
                intent.putExtra(
                  Constants.REMOTE_MESSAGE_CALL_ROOM,
                  remoteMessage.getData().get(Constants.REMOTE_MESSAGE_CALL_ROOM)
                );
